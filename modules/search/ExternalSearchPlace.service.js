...
export default function ExternalSearchPlace(value) {
    ...
    return fetch(`https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=45.5106127,-73.5676309&radius=500&keyword=${value}&key=AIzaSyByEvdNxZqKVHZphCkeW4o0j1gR3INSLSg`)
